...
{{
  ...
  "summary": "# Executive Summary\n\nNarrative of the event (Minimum 300 words). Discuss the context, the 'who', and the 'why' this matters right now.\n\n### Technical History & Context\nDiscuss evolution of this threat.\n\n### Definitions\nExplain technical terms here.",
  "attack_vector": "## Technical Vector & Methodology\n\nExhaustive breakdown of the attack chain. Detail the vulnerabilities exploited, the persistence mechanisms, and the exfiltration tactics.\n\n* **Persistence**: How they stay.\n* **Exfiltration**: How they steal.\n\n(IMPORTANT: ALWAYS put a newline before every '*')",
  "impact": "## Business & Operational Impact\n\nDeep analysis of financial, legal, and reputational risks. Discuss regulatory implications (GDPR, etc.) and the ripple effect on the supply chain. (Minimum 300 words).",
