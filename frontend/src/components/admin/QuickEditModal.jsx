                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-4 h-[42px] px-4 rounded-2xl bg-slate-950/50 border border-slate-800/50">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-black uppercase text-slate-400">Total Words: {wordCount(markdownContent)}</span>
                                        </div>
                                        <div className="h-4 w-px bg-slate-800" />
                                        <span className={`text-[10px] font-black uppercase ${wordCount(markdownContent) >= 1000 ? 'text-emerald-500' : 'text-amber-500'}`}>
                                            {wordCount(markdownContent) >= 1000 ? 'AdSense Optimized' : 'Needs More Depth'}
                                        </span>
                                    </div>
                                </div>
                            </div>
