                    ...
                    <div className="animate-in fade-in duration-500">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
                            ...
                            <StatCard
                                ...
                                color="bg-yellow-600"
                                loading={isLoading}
                                subtitle="Reports last 24h"
                            />
                            <StatCard
                                title="Depth of wisdom"
                                value={stats?.avg_views}
                                icon={BarChart3}
                                color="bg-emerald-600"
                                loading={isLoading}
                                subtitle="Avg views / article"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                            <div className="card p-6 flex flex-col justify-between border-l-4 border-l-blue-500">
                                <div>
                                    <h3 className="text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1">Weekly Momentum</h3>
                                    <div className="flex items-center gap-2">
                                        <GrowthBadge value={stats?.growth_pct || 0} />
                                    </div>
                                    <p className="text-[10px] text-slate-500 font-bold uppercase mt-2">Publishing velocity vs last week</p>
                                </div>
                            </div>

                            <div className="card p-6 flex flex-col justify-between border-l-4 border-l-purple-500">
                                <div>
                                    <h3 className="text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1">Search Authority</h3>
                                    ...
                                    <p className="text-[10px] text-slate-500 font-bold uppercase mt-2">Rank across top categories</p>
                                </div>
                            </div>

                            <div className="card p-6 flex flex-col justify-between border-l-4 border-l-orange-500">
                                <div>
                                    <h3 className="text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1">Primary Threat Focus</h3>
                                    <div className="flex items-center gap-2">
                                        <Flame className="w-5 h-5 text-orange-500" />
                                        <span className="text-lg font-black text-white uppercase truncate">{stats?.top_category || 'N/A'}</span>
                                    </div>
                                    <p className="text-[10px] text-slate-500 font-bold uppercase mt-2">Most engaging category</p>
                                </div>
                            </div>
                        </div>
